...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1.5 rounded-md border border-ink/15 px-2.5 py-1.5 text-sm font-medium text-ink hover:bg-mint focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal ${theme === null ? "invisible" : ""} ${className ?? ""}`}
    >
